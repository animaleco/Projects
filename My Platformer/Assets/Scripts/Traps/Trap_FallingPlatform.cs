...
public class Trap_FallingPlatform : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        if(player != null)
        {
            Invoke(nameof(SwitchOffPlatform), fallDelay); // Invoke se usa para llamar a un metodo con delay "nameof" es mejor practica que poner entre comillas el nombre del metodo
